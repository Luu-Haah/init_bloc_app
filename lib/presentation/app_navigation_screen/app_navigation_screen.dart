...
class AppNavigationScreen extends StatelessWidget {
  ...
  /// Navigates to the screenOneScreen when the action is triggered.
  ///
  /// The [BuildContext] parameter is used to build the navigation stack.
  /// When the action is triggered, this function uses the `NavigatorService`
  /// to push the named route for the screenOneScreen.
  onTapScreenOne(BuildContext context) {
    NavigatorService.pushNamed(
      AppRoutes.screenOneScreen,
    );
  }
  ...
  /// The [BuildContext] parameter is used to build the navigation stack.
  /// When the action is triggered, this function uses the `NavigatorService`
  /// to push the named route for the screenTwoScreen.
  onTapScreenTwo(BuildContext context) {
    NavigatorService.pushNamed(
